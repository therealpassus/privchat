...
<div
	class={cn(
		"flex w-full items-center rounded-2xl border border-white/20 dark:border-white/[0.06] bg-background/70 backdrop-blur-xl px-2.5 shadow-lg transition-colors",
